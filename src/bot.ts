...
export interface Session {
  step?: "email" | "code" | "confirm_unbind";
  binding?: {
    telegramId: number;
    displayName: string;
    email: string;
  ...
  token?: { code: string; createdAt: string; expiresAt: string; used: boolean };
  resendTimes?: string[];
  audit?: Array<{ event: string; timestamp: string; email: string; actor: string }>;
}
